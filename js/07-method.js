...
/* ============================================================
  ...
  const GENERIC_METHOD = {
    ...
    'carb:porridge':{o:3, t:'Cook the {n} in about three times its volume of water, stirring, until it thickens. Milk instead is richer, but it is absorbed and counts.'},
    'carb:oats':    {o:3, t:'Cook the {n} in about three times their volume of water until thick, or soak them overnight in the fridge. Milk instead makes it richer, but the oats drink it — log it if you use it.'},
