...
/* ============================================================
  ...
  const THEMES = {
    cyberpunk: {
      ...
      words:{ tier:"TIER", promoTitle:"UPGRADE AVAILABLE", promoYes:"INSTALL", loadout:"LOADOUT", quest:"QUEST", journal:"INTAKE", stat:"STAT", inventory:"INVENTORY",
    ...
    fantasy: {
      ...
      words:{ tier:"RANK", promoTitle:"A PROMOTION AWAITS", promoYes:"ACCEPT THE MANTLE", loadout:"PROVISIONS", quest:"QUEST", journal:"CHRONICLE", stat:"ATTRIBUTE", inventory:"LARDER",
    ...
    fps: {
      ...
      words:{ tier:"CLASS", promoTitle:"PROMOTION ORDERS", promoYes:"ACCEPT ORDERS", loadout:"LOADOUT", quest:"OBJECTIVE", journal:"SITREP", stat:"METRIC", inventory:"ARMORY",
    ...
    survival: {
      ...
      words:{ tier:"GRADE", promoTitle:"NEW ROLE OPEN", promoYes:"TAKE THE ROLE", loadout:"SUPPLY RUN", quest:"TASK", journal:"RATIONS", stat:"READOUT", inventory:"STASH",
    ...
    farm: {
      ...
      words:{ tier:"SEASON", promoTitle:"A NEW SEASON", promoYes:"LET IT BLOOM", loadout:"HARVEST", quest:"CHORE", journal:"DAYBOOK", stat:"YIELD", inventory:"ROOT CELLAR", inventoryTab:"Cellar",
    ...
    craft: {
      ...
      words:{ tier:"LEVEL", promoTitle:"LEVEL UP", promoYes:"CLAIM THE LEVEL", loadout:"HOTBAR", quest:"TASK", journal:"HUNGER", stat:"BAR", inventory:"CHEST",
    ...
    outdoors: {
      ...
      words:{ tier:"TAG", promoTitle:"NEW TAG ISSUED", promoYes:"TAKE THE TAG", loadout:"KIT", quest:"OUTING", journal:"MESS", stat:"READING", inventory:"COOLER",
    ...
    horror: {
      ...
      words:{ tier:"CHAPTER", promoTitle:"THE NEXT CHAPTER", promoYes:"TURN THE PAGE", loadout:"SUPPLIES", quest:"NIGHT", journal:"INTAKE", stat:"VITALS", inventory:"SATCHEL",
    ...
    racing: {
      ...
      words:{ tier:"CLASS", promoTitle:"LICENSE UPGRADE", promoYes:"MOVE UP A CLASS", loadout:"SETUP", quest:"STINT", journal:"FUEL", stat:"TELEMETRY", inventory:"GARAGE",
    ...
    arcade: {
      ...
      words:{ tier:"STAGE", promoTitle:"STAGE CLEAR", promoYes:"CONTINUE", loadout:"POWER-UPS", quest:"ROUND", journal:"REFUEL", stat:"SCORE", inventory:"ITEM SELECT", inventoryTab:"Items",
